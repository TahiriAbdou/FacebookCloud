...
{!! Form::open(['action'=>'Dashboard\\HotelsController@store']) !!}
<div class="row">
	<div class="col-md-12">
		<div class="box box-warning">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs pull-right box-header with-border">
					...
					<li class="pull-left header"><i class="fa fa-bed"></i> Adding new hotel</li>
				</ul>
			</div>
		</div>
	</div>
	<div class="col-md-12">
		<div class="nav-tabs-custom">
			...
			<div class="tab-content">
				@include('dashboard.hotels.listing.partials._form',['locale'=>'','action'=>'add'])
				<hr>
				<div class="form-group">
					{!! Form::submit('Add Hotel',['class'=>'btn btn-primary btn-flat']) !!}
				</div>
			</div>
		</div>
	</div>
